  ...
  return (
    <div className="bg-black text-white h-162.5 w-full">
      <Marquee className='py-6 ' speed={50}>
        ...
        <img className='h-20 mx-16' src="" alt="" />
      </Marquee>
      <div className='flex divide-x items-start pt-15 justify-around'>
        <div className='px-10 text-center'>
        <p className='font-semibold p-18 text-3xl'>7+ <br />Years of Excellence</p>
        <p className='text-2xl'>Delivering Innovation for 7+ years, earning a reputation for innovation and reliability.</p>
      </div>
      <div className='px-10 text-center'>
        <p className='font-semibold text-3xl p-18'>50+ <br />Successful Projects</p>
        <p className='text-2xl'>Proven success with over 50+ projects delivered effectively across diverse IT domains.</p>
      </div>
      <div className='px-10 text-center'>
        <p className='font-semibold text-3xl p-18'>90% <br />Client Satisfaction</p>
